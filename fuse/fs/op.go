...
// root is at the given root. This node implements all fs.NodeXxxxer
// operations available.
func NewLoopbackRoot(rootPath, ApiAddr, DBAddr, DBKey string) (fs.InodeEmbedder, error) {
	...
	client, err := NewClient(ApiAddr, DBAddr, DBKey)
	if err != nil {
		return nil, err
	}
